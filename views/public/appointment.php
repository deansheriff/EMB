<section class="page-hero">
    <div class="mx-auto max-w-content px-5 py-20 lg:px-6 lg:py-28">
        ...
        <p class="mt-6 max-w-2xl text-lg leading-8 text-muted">Tell us what kind of support you need and when you would prefer to meet. We will contact you to confirm availability.<?php if ($paymentRequired): ?> Your request continues to secure Paystack checkout.<?php endif; ?></p>
    </div>
</section>
    ...
    <div class="mx-auto grid max-w-content gap-8 px-5 lg:grid-cols-[1.15fr_.85fr] lg:px-6">
        <div class="rounded-[28px] border border-line bg-white p-6 shadow-soft sm:p-9">
            ...
            <form method="post" action="<?= e(url('/appointment')) ?>" class="space-y-9">
                ...
                <fieldset><legend class="form-section-title"><span>02</span> Preferred timing</legend><div class="mt-5 form-grid"><div class="form-field"><label for="preferred-date">Preferred date</label><input class="form-control" type="date" id="preferred-date" name="preferred_date" value="<?= e(old('preferred_date')) ?>" min="<?= date('Y-m-d') ?>"></div><div class="form-field"><label for="preferred-time">Preferred time</label><input class="form-control" type="time" id="preferred-time" name="preferred_time" value="<?= e(old('preferred_time')) ?>"></div></div></fieldset>
